...
// DIR
define('DIR_APPLICATION', 'C:/OpenServer/domains/kazeco.local/admin/');
define('DIR_SYSTEM', 'C:/OpenServer/domains/kazeco.local/system/');
define('DIR_LANGUAGE', 'C:/OpenServer/domains/kazeco.local/admin/language/');
define('DIR_TEMPLATE', 'C:/OpenServer/domains/kazeco.local/admin/view/template/');
...
define('DIR_CATALOG', 'C:/OpenServer/domains/kazeco.local/catalog/');
